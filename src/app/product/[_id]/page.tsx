          ...
          >
            <div className="border-t border-neutral-200 pt-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-4xl font-bold text-neutral-800 font-cormorantGaramond">
                  You May Like
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                  {relatedProducts.map((relatedProduct, index) => (
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-neutral-800 group-hover:text-neutral-600 transition-colors line-clamp-1">
                        {relatedProduct.name}
                      </h4>
