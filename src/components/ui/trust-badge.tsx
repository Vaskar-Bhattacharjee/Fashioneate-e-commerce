  ...
  return (
    <section className="relative py-20 w-full">
      <Container className="relative border border-neutral-200 w-[90%] md:w-[85%] mx-auto bg-white">
        ...
        {/* Corner Brackets - Your original precision design */}
          ...
          {TrustElement.map(({ Icon, title }, index) => (
            <div
              ...
              className={cn(
                ...
                // 1. Right border for all except the last item in a row
                // On mobile (2 cols): border-r on index 0 and 2
                // On desktop (4 cols): border-r on index 0, 1, 2
                index % 2 === 0 ? "border-r border-neutral-200" : "lg:border-r lg:border-neutral-200",
                index === 1 && "lg:border-r border-neutral-200", 
                index === 3 && "border-none",
                
                // 2. Bottom border for the top row on mobile only
