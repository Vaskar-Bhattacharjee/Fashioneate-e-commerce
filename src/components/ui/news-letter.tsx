...
export const Newsletter = () => {
  return (
    <section className="py-24 w-full bg-white">
      <Container className="relative border border-neutral-200 w-[90%] md:w-[70%] lg:w-[80%] mx-auto px-16 py-10 text-center">
        ...
        <div className="w-12 h-px bg-neutral-300 mx-auto mb-5" />
        ...
        >
          <input
            ...
            className="w-full bg-transparent border-b border-neutral-400 py-4 pl-0 pr-10 text-sm text-left pl-4
          ...
          <button
            type="submit"
            className="absolute right-0 bottom-3 text-neutral-700 hover:text-neutral-900 transition-colors"
